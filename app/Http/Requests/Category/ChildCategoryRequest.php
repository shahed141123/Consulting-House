...
class ChildCategoryRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'sub_category_id.required' => 'The sub category name is required.',
            'name.required' => 'The child category name is required.',
            'image.image' => 'The child category file must be an image.',
