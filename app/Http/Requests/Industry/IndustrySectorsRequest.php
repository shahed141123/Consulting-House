...
class IndustrySectorsRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'parent_id'   => 'nullable|exists:industry_sectors,id',
    ...
    {
        return [
            'parent_id.exists'  => 'The selected parent sector does not exist.',
