...
@section('content')
    ...
    <div class="row">
        <div class="card">
            <div class="card-header d-flex flex-wrap">
                <h6 class="mb-0">Pick Up Point Table</h6>
                <div class="d-inline-flex ms-auto">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#PickUpPointAddModal"
                                        ...
                                        <td>
                                            <div class="d-inline-flex">
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#PickUpPointEditModal" class="text-primary mx-1">
                                                    <i class="ph-pen"></i>
                                                </a>
    ...
    <!-- Disabled keyboard interaction Add modal for PickUpPoint -->
    <div id="PickUpPointAddModal" class="modal fade" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-secondary">Add Pick Up Point</h5>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    {{-- <span class=" show_focus_text"
                                        style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point Name</span> --}}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    {{-- <span class=" show_focus_text"
                                        style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point City
                                        Name</span> --}}
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    {{-- <span class="show_focus_text"
                                        style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point
                                        State</span> --}}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="zip_code" value="" type="text"
                                            ...
                                            maxlength="100">
                                        {{-- <span class="show_focus_text"
                                            style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point Zip
                                            Code</span> --}}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="contact_name" value="" type="text"
                                            ...
                                            maxlength="100">
                                        {{-- <span class=" show_focus_text"
                                            style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point Contact
                                            Name</span> --}}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-2">
                                    ...
                                    <input name="contact_phone" value="" type="email"
                                        class="form-control form-control-sm" placeholder="Enter Contact Phone"
                                        maxlength="100">
                                    {{-- <span class=" show_focus_text"
                                        style="color: #174a62; font-size: 12px; display: none;">Enter Pick Up Point
                                        Email</span> --}}
    ...
    <!-- Disabled keyboard interaction Edit modal for PickUpPoint -->
    <div id="PickUpPointEditModal" class="modal fade" data-bs-keyboard="false" data-bs-backdrop="static"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
