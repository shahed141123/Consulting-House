...
@section('content')
        ...
        <div class="page-header-content d-lg-flex border-top">
            <div class="d-flex">
                <div class="breadcrumb py-2">
                    ...
                    <span class="breadcrumb-item active">Client Types</span>
                </div>
    ...
    <div class="content">
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <div class="text-success table_header_content">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#client_typeAddModal"
                        ...
                        <table class="table table-bordered table-striped client_type_table table-hover">
                            <thead>
                                ...
                                @if ($client_types)
                                    @foreach ($client_types as $client_type)
                                        <tr>
                                            ...
                                            <td>{{ $client_type->getProfileTypeName() }}</td>
                                            <td>{{ $client_type->name }}</td>
                                            <td>
                                                <div class="d-inline-flex">
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#client_typeEditModal{{ $client_type->id }}"
                                                        class="text-primary">
                                                        <i class="ph-pen"></i>
                                                    </a>

                                                    <a href="{{ route('admin.client_type.destroy', $client_type->id) }}"
        ...
        <div id="client_typeAddModal" class="modal fade" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.client_type.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-2">
                                        ...
                                        <input id="name" name="name" type="text"
                                            class="form-control form-control-sm" placeholder="Enter Client  Type Name"
                                            maxlength="100">
                                    </div>
                                </div>
                                <div class="col-lg-4">
        ...
        <!-- Disabled keyboard interaction add modal for client_type -->
        <!-- /Edit Modal -->
        @foreach ($client_types as $client_type)
            <div id="client_typeEditModal{{ $client_type->id }}" class="modal fade" data-bs-keyboard="false"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.client_type.update', $client_type->id) }}" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <select name="profile_type_id" data-placeholder="Select a category..."
                                                ...
                                                <option></option>
                                                @foreach ($profile_types as $profile_type)
                                                    <option value="{{ $profile_type->id }}" @selected($profile_type->id == $client_type->profile_type_id)>
                                                        {{ $profile_type->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <select name="category_id" class="form-control form-control-sm select"
                                                ...
                                                @foreach ($client_type_categories as $client_type_categorie)
                                                    <option value="{{ $client_type_categorie->id }}"
                                                        @selected($client_type_categorie->id == $client_type->category_id)>
                                                        {{ $client_type_categorie->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="mb-2">
                                            ...
                                            <input id="name" name="name" value="{{ $client_type->name }}"
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select name="status" data-placeholder="Select Status..."
                                            ...
                                            data-container-css-class="select-sm">
                                            <option></option>
                                            <option value="active" @selected($client_type->status == 'active')>Active</option>
                                            <option value="inactive" @selected($client_type->status == 'inactive')>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
