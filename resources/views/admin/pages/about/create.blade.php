                                                                 ...
                                                                 <div class="col-lg-6">
                                                                     <div class="mb-2">
                                                                         ...
                                                                         <input type="text" id="section_one_sub_title"
                                                                             name="section_one_sub_title" value=""
                                                                             class="form-control form-control-sm "
                                                                             maxlength="50"
                                                                 ...
                                                                 <div class="col-lg-6">
                                                                     <div class="mb-2">
                                                                         ...
                                                                         <input type="file"
                                                                             ...
                                                                             class="form-control form-control-sm "
                                                                             maxlength="200"
                                                                             placeholder="Enter CEO Section Signature Image">
                                                                     </div>
                                                                 </div>
                                                                 <div class="col-lg-6">
                                                                     <div class="row gx-0 d-flex align-items-center">
                                                                         <div class="col-lg-10">
                                                                             <div class="mb-2">
                                                                                 ...
                                                                                 <input type="file"
                                                                                     ...
                                                                                     class="form-control form-control-sm  rounded-0"
                                                                                     placeholder="Enter CEO Section Image">
                                                                             </div>
                                                                         </div>
                                                                         <div class="col-lg-2">
                                                                             <label class="form-label"></label>
                                                     ...
                                                     <div class="col-lg-12">
                                                         <div class="mb-2">
                                                             ...
                                                             <textarea class="form-control form-control-sm" id="ckeditor_classic_empty_2" rows="2"
                                                                 name="ceo_section_description" placeholder="Enter your text..."></textarea>
                                                         </div>
                                                     </div>
                                                 </div>
                                                                 ...
                                                                 <div class="row gx-0">
                                                                         ...
                                                                         <div class="col-lg-10">
                                                                             <div class="mb-2">
                                                                                 ...
                                                                                 <input type="file"
                                                                                     ...
                                                                                     class="form-control form-control-sm rounded-0"
                                                                                     placeholder="Enter Choose Us One Image">
                                                                             </div>
                                                                         </div>
                                                                         <div class="col-lg-2">
                                                                             <label class="form-label"></label>
                                                                     ...
                                                                     <div class="mb-2">
                                                                         ...
                                                                         <textarea class="form-control form-control-sm" name="choose_us_one_description"
                                                                             placeholder="Enter Choose Us One Description"></textarea>
                                                                     </div>
                                                                 </div>
                                                             </div>
                                                         </div>
                                                             ...
                                                             <div class="p-3 bg-light">
                                                                     ...
                                                                     <div class="col-lg-10">
                                                                         <div class="mb-2">
                                                                             ...
                                                                             <input type="file"
                                                                                 ...
                                                                                 class="form-control form-control-sm rounded-0"
                                                                                 placeholder="Enter Choose Us Two Image">
                                                                         </div>
                                                                     </div>
                                                                     <div class="col-lg-2">
                                                                         <label class="form-label"></label>
                                                                 ...
                                                                 <div class="mb-2">
                                                                     ...
                                                                     <textarea class="form-control form-control-sm" id="choose_us_two_description" name="choose_us_two_description"
                                                                         placeholder="Enter Choose Us Two Description"></textarea>
                                                                 </div>
                                                             </div>
                                                         </div>
                                                         <div class="col-lg-4">
                                                             <div class="p-3 bg-light">
                                                                     ...
                                                                     <div class="col-lg-10">
                                                                         <div class="mb-2">
                                                                             ...
                                                                             <input type="file"
                                                                                 ...
                                                                                 class="form-control form-control-sm  rounded-0"
                                                                                 placeholder="Enter Choose Us Three Image">
                                                                         </div>
                                                                     </div>
                                                                     <div class="col-lg-2">
                                                                         <label class="form-label"></label>
                                                                 ...
                                                                 <div class="mb-2">
                                                                     ...
                                                                     <textarea class="form-control form-control-sm" id="choose_us_three_description" name="choose_us_three_description"
                                                                         placeholder="Enter Choose Us Three Description"></textarea>
                                                                 </div>
                                                             </div>
                                                         </div>
                                                     </div>
