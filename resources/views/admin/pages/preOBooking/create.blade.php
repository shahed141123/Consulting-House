...
@section('content')
    <div class="container border border-secondary bg-white rounded">
        <div class="row rounded border border-bottom-secondary d-flex align-items-center p-2 shadow-lg">
            <div class="col-lg-1">
                <a href="{{ route('admin.pre-booking.index') }}">
            ...
            <div class="col-lg-11 border-bottom-secondary">
                <h1 class="text-secondary text-center p-0 m-0">Add Pre-Booking Form</h1>
            </div>
        </div>
        <div class="row p-3">
            <div class="col-lg-12">
                <!-- Pre booking Create Form Start -->
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm daterange-single"
                                        name="booking_date" value="03/18/2013" placeholder="Enter Booking Date">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="mb-2">
                                ...
                                <input name="booking_time" value="" type="time"
                                    class="form-control form-control-sm" placeholder="Enter Booking Time" maxlength="100">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="mb-2">
