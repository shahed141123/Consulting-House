                    ...
                    <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control form-control-sm phone_number"
                                                    name="mobile_number" value="{{ Auth::user()->phone }}"
                                                    id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                        ...
                        <div>
                            <div class="form-section ">
                                ...
                                <div class="container">
                                    {{-- First Row --}}
                                    <input type="hidden" name="profile_type_id" value="{{ $profile_type->id }}">
                                    <div class="row pt-3 pb-0">
                                        <div class="col-lg-4">
                                            <div class="mb-1">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">Mention highlights of
                                                    the business including number of clients, growth rate, promoter
                                                    experience,
                                    ...
                                    <div class="row pt-3 pb-0">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="w-100">
                                                <input name="monthly_expected_sales" type="text"
                                                    class="form-control form-control-sm price" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp">
                                    ...
                                    <div class="row pt-3 pb-0">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="w-100">
                                                <input name="ebitda_margin_percentage" type="text"
                                                    class="form-control form-control-sm price" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-1">
                                                <label for="exampleInputEmail1" class="form-label">What is the value of
                                                    physical assets owned by
                                                    the business that would be part of the transaction?</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="w-100">
                                                <input name="yearly_turnover" type="text"
                                                    class="form-control form-control-sm price" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp">
