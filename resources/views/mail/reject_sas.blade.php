...
<head>
    ...
    <title>Product Sourcing Rejection Notification</title>
</head>
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:center;padding:15px 15px 5px 15px;font-size:18px">
                       " {{$data['name']}} " this Product is rejected by {{ $data['reject_by'] }}
                    </td>
                </tr>

                <tr>
                    <td style="padding:0 15px">
                        <p>The following is the short details of the Product:</p>
                ...
                {{-- <tr>
                    <td style="padding:15px;text-align:center;font-size:12px">
                        <div style="padding-bottom:5px;margin-bottom:10px;font-size:14px !important;">
                            <strong>
                ...
                <tr>
                    <td style="padding:15px 0;text-align:center;background-color:#eaeaea;font-size:14px">
                        Thank you, from Logistics Department<strong>ngenitltd.com</strong>
                    </td>
                </tr>
            </tbody>
        </table>
