                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="mt-3 mb-5">
                                    @foreach ($profile_types as $profile_type)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="profile_type" value="{{ $profile_type->slug }}"
                                                id="profile_types">
                                ...
                                <div class="mt-3 mb-5">
                                    @foreach ($transaction_types as $transaction_type)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="transaction_type" value="{{ $transaction_type->slug }}"
                                ...
                                <div class="mt-3 mb-5">
                                    @foreach ($entity_types as $entity_type)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="entity_type" value="{{ $entity_type->slug }}"
                                                id="entity_types">
                                ...
                                <div class="input-group input-group-sm" style="max-width: 400px;">
                                    ...
                                    <input id="location-filter" type="text" class="form-control form-control-sm"
                                        placeholder="Filter...">
                                </div>
                                {{-- Nested Accordion --}}
