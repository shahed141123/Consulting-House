            ...
            <div class="col-lg-4 z-5">
                <div class="contact-area relative h-100 mr-lg-20 mr-md-00">
                    ...
                    <div class="contact-options mb-35">
                        <ul>
                            <li>
                                <i class="fas fa-map-marker-alt navy"></i>89/2, Haque Chamber, Panthapath, Dhaka 1205,
                                Bangladesh
                            </li>
                            <li>
                                <i class="fas fa-phone navy"></i>(1) 234 456 89
                            </li>
                            <li>
                                <i class="fas fa-envelope navy"></i>info@example.com
                            </li>
                        </ul>
                    </div>
