...
@section('content')
        ...
        <div class="container">
            <div class="row z-5 align-items-center">
                <div class="col-md-8 text-center text-md-left">
                    <h1 class="f-700 green">Sign Up</h1>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-xl-5 col-lg-6 ">
                    <div class="form-area bg-light-white">
                        <h2 class="f-700 mb-15">Create an Account</h2>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group relative mb-25 mb-sm-20">
                                <input type="email" class="form-control input-lg input-white shadow-5" id="email"
                            ...
                            <div class="form-group relative mb-20 mb-sm-20">
                                <input type="password" class="form-control input-lg input-white shadow-5" id="confirm_password"
                            ...
                            <div class="signup-login text-center">
                                <p class="mt-15 fs-13">
                                    Already a member?<a href="{{ route('login') }}" class="ml-5 mb-0 d-inline-block f-500">Login</a>
                                </p>
                            </div>
                        </form>
                    </div>
    ...
    <section class="experience-cta pt-100 pb-100" style="background-image: url('{{ asset('frontend') }}/img/bg/bg-2.jpg');"
        data-overlay="9">
        <div class="container">
